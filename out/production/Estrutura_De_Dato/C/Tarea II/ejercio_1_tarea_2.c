...
int main() {
    int pp, pp1, pp2, tg;
    /*
     * pp es igual a personas recortadas por peluquero
    ...
    printf("personas recortadas por peluquero: ");
    scanf("%i", &pp);

    printf("personas recortadas por peluquero 1: ");
    scanf("%i", &pp1);

    printf("personas recortadas por peluquero 2: ");
    scanf("%i", &pp2);

    tg = pp + (pp1 * 0.25) + (pp2 * 0.25);
