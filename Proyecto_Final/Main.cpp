...
int main(){
	...
	do{
		...
		cin>>a;	
		switch(a){
			case 1:opc1(route);break;
		
			case 2:	E.enviar(route,puerto);	break;
			
			case 3:enviarmesensaje(puerto,route);break;
			
			case 4:buscarmesensaje(puerto,route);break;
