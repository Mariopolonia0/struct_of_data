program proyecto_final_pascal;  //hecho por mario peña polonia matricula 2016-0037
 ...
 var
    ...
    dosp1,dosp2,dosp3,dosp4,dosp5:integer;tdos:integer;
    t1,t2,t3,t4,t5,t6:integer;
    trep1,trep2,trep3,trep4,trep5:integer;
    ttrep:integer;
    t12,t22,t32,t42,t52,t62:integer;
    lp1,lp2,lp3,lp4,lp5:integer;tlp:integer;                       

    dosp12,dosp22,dosp32,dosp42,dosp52:integer;
    tdos2 :integer;
    trep12,trep22,trep32,trep42,trep52:integer;
    ttrep2:integer;          
    lp12,lp22,lp32,lp42,lp52 :integer;           
    tlp2:integer;
...
begin
 ...
 gotoxy(10,3);
 textcolor(7);
 write('digite nombre de equipo 1 = ');
 readln(eq1);
 
 textcolor(3);
 gotoxy(10,5);
 write('digite nombre del jugador numero 1 = ');
 readln(j1e1);
 
 gotoxy(10,6);
 write('digite nombre del jugador numero 2 = ');
 readln(j2e1);   
 
 gotoxy(10,7);
 write('digite nombre del jugador numero 3 = ');
 readln(j3e1);
 
 gotoxy(10,8);
 write('digite nombre del jugador numero 4 = '); 
 readln(j4e1);
 ...
 gotoxy(10,3);
 textcolor(7);
 write('digite nombre de equipo 2 = ');
 readln(eq2);
