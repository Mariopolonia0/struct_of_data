 ...
 if e>17 then begin
  ...
  me:=me+1
	...
	WriteLn(me,'  son las edades menores ');
             WriteLn('');    WriteLn('precione cualquier boton para salir');
    readkey     ;
